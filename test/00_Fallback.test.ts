...
describe("Fallback contract deployment & tests on zkEVM", async () => {
    ...
    before(async () => {
        ...
        const fallback_factory = new ethers.ContractFactory(fallback_artifacts.abi, fallback_artifacts.bytecode, ownerSigner);
        const sendToFallback_factory = new ethers.ContractFactory(sendToFallback_artifacts.abi, sendToFallback_artifacts.bytecode, ownerSigner);
        ...
        sendToFallback = new Contract(sendToFallback_contract.address, sendToFallback_artifacts.abi, zkEVM_provider);
